...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/ti81ai4bbtmd1 (1).jpg",
			"assets/images/DesktopWallpaper/realesrgan-output.png",
	...
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"Crossing The Ocean.",
				"The dragon had eaten the boxer.",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
