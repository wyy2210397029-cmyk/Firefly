...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		...
		// 国际推荐: https://cdn.jsdelivr.net/npm/twikoo@1.7.11/dist/twikoo.min.js
		jsUrl: "https://registry.npmmirror.com/twikoo/1.7.11/files/dist/twikoo.min.js",
	...
	giscus: {
		// 设置 Giscus 评论系统仓库
		repo: "wyy2210397029-cmyk/Firefly",
		// 设置 Giscus 评论系统仓库ID
		repoId: "R_kgDOSxpGtg",
		// 设置 Giscus 评论系统分类
		category: "Announcements",
		// 获取 Giscus 评论系统分类ID
		categoryId: "DIC_kwDOSxpGts4C-jw1",
		// 获取 Giscus 评论系统映射方式
		mapping: "title",
		// 获取 Giscus 评论系统严格模式
		strict: "0",
