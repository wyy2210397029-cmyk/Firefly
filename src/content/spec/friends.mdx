...
export const notes = [
  { title: "互换原则", content: "请先添加本站至您的友链页，确认后即会回添。" },
  { title: "链接维护", content: "若长期无法访问或内容失当，将移出友链。" },
  { title: "内容要求", content: "内容须正向，不得含有色情、暴力等违法违规内容。" },
  { title: "站点要求", content: "须支持 HTTPS，以原创为主，能正常访问且有持续更新。" },
];
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">请先在您的网站添加本站信息，可直接复制左侧各字段。</p>
            </div>
          </div>
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">申请模板，复制修改后发送至评论区或邮件。</p>
          ...
          <div class="flex gap-3.5">
            ...
            <div>
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">信息无误后，即添友链。</p>
            </div>
          </div>
        </div>
      </div>
